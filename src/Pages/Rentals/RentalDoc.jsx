        ...
        <div>
            ...
            <div className='mx-5 mt-5 mb-4'>
                ...
                <div className='relative'>
                    <p className={style.boldText}>Führerscheinnummer</p>
                    <input id="message" rows="4" className={style.input} placeholder="J17003WaM41" />
                    <RiCheckboxBlankCircleLine className='absolute text-[#7D7AFF] right-2 top-10' />
                </div>
                <div className='relative'>
                    <p className={style.boldText}>Datum der Erstausstellung des Führerscheins</p>
                    <input id="message" rows="4" className={style.input} placeholder="02.12.2013" />
                    <RiCheckboxBlankCircleLine className='absolute text-[#7D7AFF] right-2 top-10' />
                </div>
                <div className='relative'>
                    <p className={style.boldText}>Geburtstag</p>
                    <input id="message" rows="4" className={style.input} placeholder="27.11.1996" />
                    <RiCheckboxBlankCircleLine className='absolute text-[#7D7AFF] right-2 top-10' />
                </div>
